...
public class AppDelegate {
    ...
    public void setUserSelectionCallback(SelectionInterface userSelectionCallback) {
        this.userSelectionCallback = userSelectionCallback;
    }

    public boolean isChatSelection() {
        return isChatSelection;
    }

    public void setChatSelection(boolean chatSelection) {
        isChatSelection = chatSelection;
    }

    public ArrayList<ChattingUserList> getSelectedUserList() {
        return selectedUserList;
    }

    public void setSelectedUserList(ArrayList<ChattingUserList> selectedUserList) {
